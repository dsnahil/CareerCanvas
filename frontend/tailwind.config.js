  ...
  theme: {
    extend: {
      ...
      backgroundImage: {
        ...
        "main-gradient": "linear-gradient(180deg, #1e293b 0%, #0f172a 100%)",
        "modal-gradient": "linear-gradient(180deg, #1e293b 0%, #0f172a 100%)",
        "sidebar-gradient": "linear-gradient(90deg, #1e293b 0%, #0f172a 100%)",
        "login-gradient": "linear-gradient(180deg, #1e293b 0%, #0f172a 100%)",
        "menu-item-gradient":
        ...
        "workspace-item-selected-gradient":
          "linear-gradient(90deg, rgba(99, 102, 241, 0.3) 0%, rgba(99, 102, 241, 0.1) 100%)",
        "switch-selected": "linear-gradient(146deg, #6366f1 0%, #4f46e5 100%)",
        "glossy-card": "linear-gradient(145deg, rgba(255, 255, 255, 0.05) 0%, rgba(255, 255, 255, 0) 100%)",
        "glossy-button": "linear-gradient(145deg, rgba(255, 255, 255, 0.1) 0%, rgba(255, 255, 255, 0.05) 50%, rgba(255, 255, 255, 0) 100%)",
        "glass-effect": "linear-gradient(135deg, rgba(255, 255, 255, 0.1) 0%, rgba(255, 255, 255, 0.05) 50%, rgba(255, 255, 255, 0.02) 100%)",
      },
      fontFamily: {
        sans: [
          "plus-jakarta-sans",
      ...
      boxShadow: {
        'glossy': '0 8px 32px rgba(0, 0, 0, 0.1), inset 0 1px 1px rgba(255, 255, 255, 0.1)',
        'glossy-sm': '0 4px 16px rgba(0, 0, 0, 0.1), inset 0 1px 1px rgba(255, 255, 255, 0.1)',
        'glossy-lg': '0 12px 40px rgba(0, 0, 0, 0.15), inset 0 1px 2px rgba(255, 255, 255, 0.1)',
