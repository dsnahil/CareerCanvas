    ...
    return (
      <>
        ...
        >
          ...
          <div
            ref={sidebarRef}
            className="h-[100vh] fixed top-0 left-0 bg-theme-bg-sidebar w-[80%] p-[18px]"
          >
  ...
  return (
    <>
      <div>
        ...
        <div
          ref={sidebarRef}
          className="transition-all duration-500 relative bg-theme-bg-sidebar border-r border-theme-sidebar-border light:border-none min-w-[250px] p-[10px] h-[calc(100%-76px)]"
        >
          <div className="w-full h-full flex flex-col overflow-x-hidden items-between min-w-[235px]">
            ...
            <div className="absolute bottom-0 left-0 right-0 pt-4 pb-3 bg-theme-bg-sidebar bg-opacity-80 backdrop-filter backdrop-blur-md z-10">
              <Footer />
            </div>
          </div>
        </div>
