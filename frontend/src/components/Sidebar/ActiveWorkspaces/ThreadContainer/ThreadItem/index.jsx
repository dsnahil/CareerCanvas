...
export default function ThreadItem({
  ...
  return (
    ...
    >
      ...
      />
      <div
        className={`flex w-full items-center justify-between pr-2 group relative ${isActive ? "bg-[var(--theme-sidebar-thread-selected)] border-l-4 border-indigo-500" : "hover:bg-theme-sidebar-subitem-hover"}`}
      >
        {thread.deleted ? (
