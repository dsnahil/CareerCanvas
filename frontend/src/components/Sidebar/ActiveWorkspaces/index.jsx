            ...
            <div className="flex gap-x-2 items-center justify-between">
              <div
                className={`
                  ...
                  flex flex-grow w-[75%] gap-x-2 py-[6px] px-[12px] text-white justify-start items-center
                  bg-theme-sidebar-item-default
                  hover:bg-theme-sidebar-subitem-hover hover:font-bold
                  ${isActive ? "bg-theme-sidebar-item-selected font-bold border-l-4 border-indigo-500" : ""}
                  ${!isActive ? "cursor-pointer" : ""}
                `}
                onClick={isActive ? null : () => window.location.href = paths.workspace.chat(workspace.slug)}
              >
