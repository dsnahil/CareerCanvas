const TRANSLATIONS = {
  ...
  // Chat Settings
  chat: {
    "message-placeholder": "Type a message or use / for commands...",
  ...
  interview: {
    ...
    welcome: "Welcome to your interview session",
    description: "This interview will record your video and audio responses to a series of questions. Make sure your camera and microphone are working properly before starting.",
    beforeYouBegin: "Before you begin:",
    tips: {
      quietPlace: "Find a quiet place with good lighting",
      testEquipment: "Test your camera and microphone",
      prepareNotes: "Prepare any notes or materials you might need",
      ownPace: "You'll be able to navigate through questions at your own pace"
    },
    clickToStart: "Click the button below when you're ready to begin. The system will request access to your camera and microphone.",
    startButton: "Start Interview",
    nextButton: "Next Question",
    endButton: "End Interview",
    completed: "Interview Completed",
    completedDescription: "Your interview has been recorded successfully. You can review and download your recording below.",
    download: "Download Recording",
    downloading: "Downloading...",
    startNew: "Start New Interview",
    permissionDenied: "Camera or Microphone Access Required",
    permissionDeniedDescription: "Please allow access to your camera and microphone to use the interview feature. You may need to refresh the page and grant permissions.",
    refresh: "Refresh Page",
    settingUp: "Setting up your interview...",
    questionCount: "Question {{current}} of {{total}}",
    noRecording: "No recording available",
    recordingIndicator: "Recording",
    downloadSuccess: "Interview recording downloaded successfully",
    downloadError: "Failed to download recording",
  },
};
