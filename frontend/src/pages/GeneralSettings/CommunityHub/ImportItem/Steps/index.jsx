...
export function CommunityHubImportItemLayout({ setStep, children }) {
  ...
  return (
    <div className="h-screen overflow-hidden bg-theme-bg-container flex md:mt-0 mt-6">
      <div
        style={{ height: isMobile ? "100%" : "calc(100% - 32px)" }}
        className="relative md:ml-[2px] md:mr-[16px] md:my-[16px] md:rounded-[16px] h-full flex"
      >
